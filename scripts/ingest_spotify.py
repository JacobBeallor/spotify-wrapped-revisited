...
# Data quality filter
# Skip plays shorter than this duration (Spotify royalty standard)
...
def main():
    ...
    print(f"Minimum play duration: {MIN_PLAY_DURATION_MS/1000:.0f} seconds")
    print(f"Filtered out: {filtered_records:,} plays (skips/accidents)")
    print("=" * 60)
